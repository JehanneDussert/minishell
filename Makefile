...
MS_UTILS_FILES = skips.c split_quote.c split_quote2.c welcome_bye.c ft_init.c lst_utils.c \
				lst_utils2.c main_utils.c redirections_utils.c ft_special_char.c ft_quotes_utils.c \
				ft_quotes_utils2.c ft_restablish_char.c ft_restablish_char2.c ft_env_utils.c \
